...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "tinyodomex_oxiod_portenta_h7_approx_trained"
...
#define AI_NETWORK_IN_1_HEIGHT      (200)
#define AI_NETWORK_IN_1_CHANNEL     (10)
#define AI_NETWORK_IN_1_SIZE        (2000)
#define AI_NETWORK_IN_1_SIZE_BYTES  (2000)
...
#define AI_NETWORK_OUT_2_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_NETWORK_OUT_2_CHANNEL     (1)
#define AI_NETWORK_OUT_2_SIZE        (1)
#define AI_NETWORK_OUT_2_SIZE_BYTES  (1)

/******************************************************************************/
#define AI_NETWORK_N_NODES (55)
