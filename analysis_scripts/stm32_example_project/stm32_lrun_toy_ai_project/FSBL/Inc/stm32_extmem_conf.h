...
/*
 * The host-side LRUN runner rewrites this define from the current trusted app
 * image size before the final FSBL build. Keep it as a valid default for the
 * checked-in workspace, but do not treat it as a hand-maintained constant.
 */
#define EXTMEM_LRUN_SOURCE_SIZE 0x00020400
