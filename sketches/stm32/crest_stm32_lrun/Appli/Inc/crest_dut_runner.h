...
#ifndef CREST_DUT_RUNNER_H
#define CREST_DUT_RUNNER_H

/*
 * crest_dut_runner — CREST STM32 DUT contract
 *
 * This module turns the canonical STM32 LRUN App into a CREST-compatible DUT:
 ...
 *
 * Prerequisites in main.c before calling crest_dut_run_once():
 *   - DWT_Init()               — enables DWT->CYCCNT for cycle counting
 *   - DebugCom_Init()          — configures USART1 clock source and BSP COM1
 *   - crest_dut_harness_gpio_init() — configures PE9/PD0 for harness signaling
 *
...
/*
 * crest_dut_run_once — initialise, handshake, warm up, time, and report one DUT
