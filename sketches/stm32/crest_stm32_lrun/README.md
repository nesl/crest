...
- Replaced the stock ST template README with CREST-specific `dev_boot`,
...
- `Appli/` carries the CREST DUT runtime.
- The ST Edge AI `network*` files and `crest_dut_phase_config.h` are staged
