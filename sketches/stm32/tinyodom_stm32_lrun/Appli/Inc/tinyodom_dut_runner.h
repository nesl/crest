#ifndef TINYODOM_DUT_RUNNER_H
#define TINYODOM_DUT_RUNNER_H

/*
 * tinyodom_dut_runner — TinyODOM STM32 DUT contract
 *
 ...
 *
 * Prerequisites in main.c before calling tinyodom_dut_run_once():
 *   - DWT_Init()               — enables DWT->CYCCNT for cycle counting
 *   - DebugCom_Init()          — configures USART1 clock source and BSP COM1
 *   - tinyodom_dut_harness_gpio_init() — configures PE9/PD0 for harness signaling
 *
...
/*
 * tinyodom_dut_run_once — initialise, handshake, warm up, time, and report one DUT
