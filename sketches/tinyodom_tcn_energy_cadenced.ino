// TinyODOM Arduino cadenced runtime sketch.
// This runs one invoke per latency-budget slot and reports average energy per
// scheduled slot across the full measurement window.
#include <Arduino.h>
