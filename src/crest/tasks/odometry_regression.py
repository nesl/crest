...
"""Odometry regression task adapter for the modular CREST pipeline."""
...
class OdometryRegressionTask(TaskABC):
    """Two-head velocity-regression task matching the current CREST behavior.
    ...
    def build_target_spec(
        ...
        """Return the current CREST two-output regression contract.
        ...
        -------
        TargetSpec
            Current CREST output contract: ``task_type="regression"``,
    ...
    def compile_model(
        ...
        """Compile a model using the current odometry regression losses.
    ...
    def build_fit_plan(
        ...
        *,
        ...
        """Build the current CREST ``model.fit(...)`` wiring.
    ...
    def evaluate(
        ...
        """Evaluate one split using the legacy odometry RMSE semantics.
    ...
    def evaluate_predictions(
        ...
        """
        del task_config, target_spec
        # Preserve the legacy output-index contract from the current CREST
