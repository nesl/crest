"""Built-in component registration for the modular CREST pipeline.

This module centralizes registration of the repository-owned dataset, task,
and model-family implementations that ship with CREST.
"""
...
def ensure_builtin_components_registered() -> None:
    """Register the built-in CREST components exactly once.
